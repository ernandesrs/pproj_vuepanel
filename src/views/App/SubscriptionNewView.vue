<template>
    ...
    <div class="flex justify-center py-5 gap-5">
        <div v-for="pack in packages" class="basis-3/12">
    ...
    <div class="flex flex-wrap justify-center py-5 gap-5">
        <div v-for="card in cards" class="basis-3/12">
    ...
    <div class="flex flex-wrap justify-center pt-5 pb-8 gap-5">
        <DefaultButton @click="toggleInstalmentSelection" v-for="instalment in instalments" :text="'' + instalment"
            variant="primary" :outlined="form.instalments === instalment ? false : true" :data-instalment="instalment" />
    </div>
    ...
    <div v-if="form.card_id && form.package_id && form.instalments" class="py-5 text-center">
        <div class="mb-6">
            ...
            <p class="mb-2">{{ (cards.find((card) => card.id === form.card_id)).number }} - {{ (cards.find((card) => card.id
                ===
...
export default {
    components: { CardElem, DefaultButton },
    data() {
        return {
            cards: null,
            packages: null,
